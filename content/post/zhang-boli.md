---
title: "张伯笠牧师 - 生命见证与宣教信息全集 🎙️"
description: "本辑集中收录张伯笠牧师的生命翻转见证及历年精选宣教主日信息。"
date: 2026-05-26
categories:
    - "见证分享"            # 👈 核心：靠这行字精准听话地钻进“见证分享”大厅！
---
...
const ap = new APlayer({
    container: document.getElementById('aplayer-author'),
    listFolded: false,     /* 默认列表全开，方便听众一眼看全 */
    audio: [
        {
            name: '生命见证（一）- 从狂人到牧者',
            artist: '张伯笠牧师',
